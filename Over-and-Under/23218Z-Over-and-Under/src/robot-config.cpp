...
motor DrivetrainLeftA = motor(PORT1,ratio18_1,true);
motor DrivetrainLeftB = motor(PORT2,ratio18_1,true);
motor DrivetrainRightA = motor(PORT5,ratio18_1,false);
motor DrivetrainLeftA = motor(PORT6,ratio18_1,false);
