...
// Drivetrain.driveFor(forward,12*PConstant,inches);
  ...
  wait(PWaitConstant,msec);
  Drivetrain.driveFor(13*PConstant,inches);
  wait(PWaitConstant,msec);
  Drivetrain.turnFor(left,60*PTurnConstant,degrees);
  wait(PWaitConstant,msec);
  ...
  wait(PWaitConstant,msec);
  Drivetrain.driveFor(26*PConstant,inches);
  pneumA();
  wait(PWaitConstant,msec);
  Drivetrain.turnFor(right,45*PTurnConstant,degrees);
  wait(PWaitConstant,msec);
  Drivetrain.setDriveVelocity(30,percent);
  Drivetrain.driveFor(11*PConstant,inches);
  wait(PWaitConstant,msec);
  Drivetrain.turnFor(right,100*PTurnConstant,degrees);
  wait(PWaitConstant,msec);
